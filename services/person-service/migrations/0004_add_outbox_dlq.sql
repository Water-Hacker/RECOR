-- Migration: 0004_add_outbox_dlq
-- Service:   person-service (TODO-040)
-- Sprint:    FATF final push
-- Rationale: mirrors services/declaration/migrations/0005_add_outbox_dlq.sql
--            and services/entity-service/migrations/0005_add_outbox_dlq.sql
--            for the person service. The outbox-relay worker (added in
...
--
-- Atomicity: identical pattern to declaration + entity —
