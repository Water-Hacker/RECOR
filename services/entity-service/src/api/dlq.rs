//! TODO-039 — operator-facing DLQ endpoints for the entity service.
//!
...
//!
//! Mirrors `services/declaration/src/api/dlq.rs`. The operator-side
//! contract — query params, response shape, auth gate, 503-on-empty-
//! allowlist — is identical so a single dashboard / on-call runbook
...
pub async fn list_dlq(
    ...
    // so the dashboard panel reflects the latest count even between
    // relay polls.
