...
/// Initialise tracing for the verification engine.
///
/// Mirrors `services/declaration::observability::init` and applies the
/// same OPS-2 redaction layer. See that file for the full rationale.
