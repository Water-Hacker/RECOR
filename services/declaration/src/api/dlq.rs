//! Operator-facing DLQ endpoints (R-LOOP-DLQ-2).
//!
...
//! dev-mode `X-Recor-Dev-Principal`, production OIDC JWT (per
//! R-DECL-1). The authorisation gate is implemented here, after auth.
//!
